...
//       console.log('Image URL from photos:', imageUrl);
...
//         </div>
//         <h2 className="text-2xl font-bold text-gray-800 mb-2">No Rented Rooms</h2>
//         <p className="text-gray-600">You haven't rented any rooms yet.</p>
//         <button
...
//             <div key={room.bookingId} className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
...
//                   <span className="text-sm font-semibold text-gray-800">₹{room.rent}/mo</span>
//                 </div>
//               </div>
...
//                 <p className="mt-3 text-gray-600 line-clamp-2">{room.description}</p>
...
//                           <span className="ml-1 text-xs">{facility}</span>
//                         </div>
//                       ))}
//                     </div>
//                   </div>
...
//                     <span>Booked on: {new Date(room.bookedAt).toLocaleDateString()}</span>
//                   </div>
...
//                     </button>
//                   ) : (
//                     <div className="mt-4 flex items-center justify-center px-4 py-2 border border-gray-200 rounded-md bg-gray-50 text-sm text-gray-500">
